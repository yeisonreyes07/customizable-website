...
describe("Montaje Básico de Componentes", () => {
  ...
  describe("ThemePanel", () => {
    it("se monta con props mínimas", async () => {
    ...
    it("muestra inputs de color", async () => {
      const { default: ThemePanel } = await import(
        "../../components/ThemePanel.vue"
      );
      const { default: MaterialIcon } = await import(
  ...
  describe("MainLayout", () => {
    it("se monta con tema básico", async () => {
    ...
    it("muestra el logo en el header", async () => {
      const { default: MainLayout } = await import(
        "../../components/MainLayout.vue"
      );
      const { default: MaterialIcon } = await import(
      ...
      const logo = wrapper.find(".main-logo");
      expect(logo.exists()).toBe(true);
      expect(logo.attributes("src")).toBe("/images/logo.gif");
    });
  });
  ...
  describe("App Component", () => {
    ...
    it("incluye los componentes principales", async () => {
      const { default: App } = await import("../../App.vue");
      const { default: ThemePanel } = await import(
        "../../components/ThemePanel.vue"
      );
      ...
      expect(wrapper.findComponent(ThemePanel).exists()).toBe(true);
